 ...
 */
public class EpicSword extends ACustomItems {

    private final Ability ability = new Ability(AbilityType.XP, 2, 5);
    private static final String KEY_NAME = "epic_sword";
    ...
    public ItemStack getItem() {
        ...
        if (meta != null) {
            meta.setDisplayName("§5Épée épique");

            List<String> lore = new ArrayList<>();
            lore.add("§7Une épée forgée dans le feu des anciens.");
            lore.add("");

            meta.addEnchant(Enchantment.BANE_OF_ARTHROPODS, 8, true);
     ...
     * @return the boolean
     */
    public static boolean isEpicSword(ItemStack item) {
