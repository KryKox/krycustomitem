 ...
 */
public class LegendaryPickaxe extends ACustomItems {
    private final Ability ability = new Ability(AbilityType.LOOT, 5, 10);
    private static final String KEY_NAME = "legendary_pickaxe";
    ...
    public ItemStack getItem() {
        ...
        if (meta != null) {
            meta.setDisplayName("§6Pioche légendaire");
     ...
     * @return the boolean
     */
    public static boolean isLegendaryPickaxe(ItemStack item) {
